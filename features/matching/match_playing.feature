...
Feature: Match Playing
  ...
  Scenario: Normal matching flow
    ...
    And mike should see indicator of "peter (1/3)"
    And mike should see indicator of "mike (1/3)"
    ...
    And mike should see indicator of "peter (1/3)" within "#match_players"
    And mike should see indicator of "mike (3/3)" within "#match_players"
    When mike press "Option #a"
    Then mike should see "You have finished the match" within "#status"
    And mike should see indicator of "peter (1/3)" within "#match_players"
    And mike should see indicator of "mike (finished)" within "#match_players"
    When peter match on league Amateur 
    Then peter should see "Match started" within "#status"
    ...
    And mike should see indicator of "peter (3/3)" within "#match_players"
    And mike should see indicator of "mike (finished)" within "#match_players"
