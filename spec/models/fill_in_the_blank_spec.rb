...
describe FillInTheBlank do
  ...
  describe "score_for" do
    it "should return 1 for correct answer without regarding to case" do
      @fib.score_for("TraVelling, Street, Girl").should == 1
    end

    it "should return less than 1 for answer with correct portion" do
      @fib.score_for("TraVelling, , Girl").should be_within(0.001).of(2.0/3)
      @fib.score_for("TraVelling, wow, Girl").should be_within(0.001).of(2.0/3)
